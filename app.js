...
// ======= Scenes data =======
const data = { "tolerance": 28, "scenes": [{ "file": "assets/scenes/scene1.png", "title": "Packing Line", "hotspots": [{ "x": 798, "y": 59, "r": 45, "tag": "no_hairnet", "desc": "No hairnet" }, { "x": 758, "y": 184, "r": 30, "tag": "beard_snood", "desc": "No beards snood" }, { "x": 831, "y": 126, "r": 34, "tag": "earplug", "desc": "No earplug" }, { "x": 766, "y": 118, "r": 30, "tag": "glasses", "desc": "No safety glasses" }, { "x": 811, "y": 402, "r": 30, "tag": "drinking", "desc": "Drink on packing area" }, { "x": 260, "y": 340, "r": 60, "tag": "box_floor", "desc": "Box on the floor" }] }, { "file": "assets/scenes/scene2.png", "title": "Mixing Area", "hotspots": [{ "x": 630, "y": 150, "r": 100, "tag": "ear_hairnet", "desc": "Ear out of hairnet and no earplug and safety glasses" }, { "x": 517, "y": 435, "r": 50, "tag": "colour_coding", "desc": "No colour coding" }, { "x": 99, "y": 459, "r": 100, "tag": "colour_coding", "desc": "No colour coding" }, { "x": 319, "y": 48, "r": 80, "tag": "dirty_wall", "desc": "Dirty wall" }, { "x": 1076, "y": 250, "r": 80, "tag": "open_bin", "desc": "Opened bin" }] }, { "file": "assets/scenes/scene3.png", "title": "Cooling Racks", "hotspots": [{ "x": 120, "y": 589, "r": 80, "tag": "tray_on_floor", "desc": "Tray on floor" }, { "x": 904, "y": 761, "r": 80, "tag": "product_floor", "desc": "Product on the floor" }, { "x": 312, "y": 689, "r": 80, "tag": "wood_pallet", "desc": "Pallet in the production floor" }] }, { "file": "assets/scenes/scene4.png", "title": "Labelling Station", "hotspots": [{ "x": 500, "y": 727, "r": 80, "tag": "labels_floor", "desc": "Labels on the floor" }, { "x": 408, "y": 451, "r": 100, "tag": "ink_spillage", "desc": "Ink spillage" }, { "x": 689, "y": 371, "r": 80, "tag": "open_product", "desc": "Open product" }] }, { "file": "assets/scenes/scene5.png", "title": "Line Start", "hotspots": [{ "x": 220, "y": 355, "r": 80, "tag": "flaky_paint", "desc": "Flaky paint" }, { "x": 49, "y": 457, "r": 80, "tag": "knife", "desc": "Knife near the line" }, { "x": 363, "y": 332, "r": 80, "tag": "pallet_wall", "desc": "Pallet touching the wall" }] }] }
// ======= State =======
let current = 0;
let found = new Set();
let img = new Image();
...
// Reference canvas size used when hotspots were recorded
const REF = { w: 1800, h: 1200 };
...
btnHint.addEventListener("click", () => {
  ...
  const hintEls = [];
  const rect = stage.getBoundingClientRect();
  const scaleX = rect.width / REF.w;

  remaining.forEach(o => {
    const el = document.createElement("div");
    el.className = "hint-ring";
    const pos = canvasClientCoords(o.h.x, o.h.y);
    const rr = o.h.r * 1.8 * scaleX;
    el.style.left = (pos.cx - rr) + "px";
